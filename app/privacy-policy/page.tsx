...
export const metadata: Metadata = {
  ...
  description: "Elora's privacy policy: end-to-end encrypted journal entries, no data selling, no ads, no AI training on your entries. Full data collection, retention, and rights disclosure.",
    ...
    <div className="min-h-screen bg-background">
      ...
      <div style={{
        ...
        <ul style={{ margin: 0, paddingLeft: '24px' }}>
          <li style={{ marginBottom: '8px' }}><strong>End-to-end encryption:</strong> All journal entries are encrypted end-to-end.</li>
          <li style={{ marginBottom: '8px' }}><strong>No data selling:</strong> We never sell your data or share it for advertising.</li>
          <li style={{ marginBottom: '8px' }}><strong>No ads:</strong> Elora does not show advertisements.</li>
          <li style={{ marginBottom: '8px' }}><strong>No AI training on your entries:</strong> Your entries are not used to train AI models.</li>
          <li style={{ marginBottom: '8px' }}><strong>You are in control:</strong> Export or delete your data at any time.</li>
          <li style={{ marginBottom: '0' }}><strong>Voice recordings:</strong> Processed for transcription, then deleted from our servers shortly after.</li>
        </ul>
      </div>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <ul style={{ marginBottom: '16px', paddingLeft: '24px' }}>
          ...
          <li style={{ marginBottom: '12px' }}>
            <strong>AI Summaries & Insights</strong> – summaries, themes, and prompts generated by AI providers including Anthropic and OpenAI.
          </li>
          <li style={{ marginBottom: '12px' }}>
            <strong>Embeddings</strong> – AI vector representations of summaries for similarity search. Embeddings are mathematical representations and cannot be reversed to recreate the original text.
          </li>
          <li style={{ marginBottom: '12px' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ margin: 0, color: 'var(--foreground)' }}>
              Entries are saved on your device first, so you can journal offline.
            </p>
          </div>
          <div style={{
            border: '1px solid var(--border)',
            ...
            <p style={{ margin: 0, color: 'var(--foreground)' }}>
              When online, entries and summaries sync securely to our servers for cross-device access and AI processing.
            </p>
          </div>
          <div style={{
            border: '1px solid var(--border)',
            ...
            <p style={{ margin: 0, color: 'var(--foreground)' }}>
              User authentication is managed via email/password or OAuth through our identity provider.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '14px', color: 'var(--foreground)' }}>AI summarization & emotional theme extraction</span>
          </div>
          <div style={{
            background: 'var(--background)',
            border: '1px solid var(--border)',
            ...
            <span style={{ fontSize: '14px', color: 'var(--foreground)' }}>AI prompts, contextual insights & chat</span>
          </div>
          <div style={{
            background: 'var(--background)',
            border: '1px solid var(--border)',
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>
          We employ industry-standard technical and organizational measures, including end-to-end encryption for journal entries, TLS (HTTPS) for data in transit, and encryption at rest on our servers. Despite these measures, no method of transmission or storage is completely secure; you use the App at your own risk.
        </p>
      </section>
